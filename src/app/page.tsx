  ...
  return (
    <main className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gray-100 rounded-full blur-2xl opacity-50"></div>
        <div className="absolute bottom-32 right-20 w-40 h-40 bg-gray-100 rounded-full blur-2xl opacity-30"></div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-8">
        ...
        <header className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/examples"
            className="group inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 shadow-sm transition-all duration-200"
        ...
        <section className="space-y-6">
          ...
          <div className="grid lg:grid-cols-5 gap-6 items-center">
            <div className="lg:col-span-3 bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-lg">
              <p className="text-xl leading-relaxed text-gray-700">
                A tiny, typed component set built with{' '}
                <strong>React + TypeScript</strong>, styled with{' '}
                <strong>Tailwind</strong>, documented with{' '}
                <strong>Storybook</strong>, and tested with{' '}
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">InputField</h3>
            ...
            <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0">
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">DataTable</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <Link
              href="/examples"
              className="inline-flex items-center justify-center rounded-lg bg-gray-900 px-6 py-3 text-white font-medium hover:bg-gray-800 transition-colors duration-200"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-6 py-3 text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-400 transition-colors duration-200"
            >
