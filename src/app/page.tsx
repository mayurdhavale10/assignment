  ...
  return (
    <main className="p-8 space-y-10">
      <header className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">React UI Components Assignment</h1>
        <Link href="/examples" className="text-blue-600 underline">
          Examples →
        </Link>
      </header>

      <section className="max-w-sm space-y-2">
        <h2 className="text-xl font-semibold">InputField (preview)</h2>
        <InputField
          label="Email"
          value={email}
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">DataTable (preview)</h2>
